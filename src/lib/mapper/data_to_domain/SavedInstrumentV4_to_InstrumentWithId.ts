...
export function mapSavedInstrumentsV4ToInstrumentWithIds(instruments: SavedInstrumentV4[]): InstrumentWithId[] {
    return instruments.map((i) => mapSavedInstrumentV4ToInstrumentWithId(i))
}

export function mapSavedInstrumentV4ToInstrumentWithId(instrument: SavedInstrumentV4): InstrumentWithId {
